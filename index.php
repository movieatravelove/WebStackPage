  ...
  <div class="left">
    <ul class="user-info-menu left-links list-inline list-unstyled">
      ...
      <?php if ($this->options->zmki_ah == '1') : ?>
        <li>
          <div class="zmki_yldh zmki_wap_zsy2" title="切换模式"><a href="javascript:switchNightMode()" target="_self"><svg class="icon zmki_dh" aria-hidden="true">
...
<div class="main-content">
  ...
  <style>
    ...
    @media (max-width:768px) {
      ...
      <?php endif; ?><?php if ($this->options->zmki_wapsl == '1') : ?>.col-sm-3 {
        width: 50%;
        float: left;
      }
