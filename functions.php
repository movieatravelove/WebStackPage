...
<?php
  // 网址
  $customSiteUrl = new Typecho_Widget_Helper_Form_Element_Text('customSiteUrl', NULL, '/usr/themes/WebStack/images/logo@2x.png', _t('自定义网站地址'), _t('用于首页标题下方网站显示'));
  $form->addInput($customSiteUrl);
  // 大logo
